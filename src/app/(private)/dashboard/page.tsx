...
const OPERATIONAL_DASHBOARD_CSS = `
.operational-dashboard { display: grid; gap: 1.25rem; }
.operational-header { align-items: flex-start; margin-bottom: 0.25rem; }
.operational-eyebrow {
  display: inline-flex;
...
html.dark .operational-eyebrow { color: var(--brand-400); }
.operational-actions { display: flex; flex-wrap: wrap; gap: 0.625rem; justify-content: flex-end; }
.operational-metrics {
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(11.5rem, 1fr));
  gap: 0.875rem;
}
.operational-metric-card { min-width: 0; min-height: 9.25rem; border-radius: 8px; }
.operational-metric-icon,
.operational-alert-icon,
.operational-issue-icon {
  display: inline-grid;
  place-items: center;
  width: 2.1rem;
  height: 2.1rem;
  border-radius: 8px;
  background: color-mix(in oklch, var(--brand-600) 12%, transparent);
  color: var(--brand-700);
}
html.dark .operational-metric-icon,
html.dark .operational-alert-icon,
html.dark .operational-issue-icon { color: var(--brand-400); }
.operational-metric-card .stat-label { margin-top: 1rem; }
.operational-main-grid {
  display: grid;
  grid-template-columns: minmax(0, 1.45fr) minmax(20rem, 0.8fr);
  gap: 1rem;
  align-items: start;
}
.operational-panel { border-radius: 8px; overflow: hidden; }
.operational-panel-subtitle { margin-top: 0.15rem; color: var(--text-muted); font-size: 0.8125rem; }
.operational-production-grid {
  display: grid;
  grid-template-columns: repeat(4, minmax(0, 1fr));
  gap: 0.75rem;
  padding: 1rem;
}
.operational-production-item,
.operational-alert,
.operational-ranking-row,
...
.operational-production-item { padding: 0.95rem; }
.operational-production-item p,
.operational-alert p,
.operational-ranking-row p,
.operational-issue-row p {
  color: var(--text-primary);
  font-size: 0.9rem;
  font-weight: 750;
}
.operational-production-item strong {
  display: block;
  margin-top: 0.3rem;
  color: var(--text-primary);
  font-size: 1.65rem;
...
.operational-production-item span,
.operational-alert span,
.operational-ranking-row span,
.operational-issue-row span,
.operational-table-meta {
...
.operational-ranking-row strong {
  color: var(--text-primary);
  font-size: 1.15rem;
  font-weight: 850;
  font-variant-numeric: tabular-nums;
}
.operational-alert-success .operational-alert-icon { background: rgb(34 197 94 / 0.11); color: #16a34a; }
.operational-alert-warning .operational-alert-icon { background: rgb(245 158 11 / 0.12); color: #d97706; }
.operational-alert-danger .operational-alert-icon { background: rgb(239 68 68 / 0.12); color: #dc2626; }
html.dark .operational-alert-success .operational-alert-icon { color: #86efac; }
html.dark .operational-alert-warning .operational-alert-icon { color: #fcd34d; }
html.dark .operational-alert-danger .operational-alert-icon { color: #fca5a5; }
.operational-table { min-width: 760px; }
.operational-table-title,
.operational-table-meta { display: block; }
.operational-table-title { color: var(--text-primary); font-weight: 700; }
.operational-ranking-row { grid-template-columns: auto minmax(0, 1fr) auto; }
.operational-rank {
  display: inline-grid;
  place-items: center;
  width: 1.9rem;
...
.operational-issue-row { grid-template-columns: auto minmax(0, 1fr) minmax(18rem, auto); }
.operational-issue-meta {
  display: flex;
  flex-wrap: wrap;
...
.operational-empty { color: var(--text-muted); text-align: center; }
.operational-empty-block {
...
@media (max-width: 1180px) {
  .operational-main-grid { grid-template-columns: 1fr; }
}
@media (max-width: 720px) {
  .operational-metrics,
  .operational-production-grid { grid-template-columns: 1fr; }
  .operational-actions { justify-content: stretch; }
  .operational-actions .btn { flex: 1 1 auto; }
  .operational-issue-row { grid-template-columns: auto minmax(0, 1fr); }
  .operational-issue-meta { grid-column: 1 / -1; justify-content: flex-start; }
}
`;
...
export default async function DashboardPage() {
  ...
  return (
    <div className="page-shell page-shell-wide operational-dashboard">
      <style>{OPERATIONAL_DASHBOARD_CSS}</style>
